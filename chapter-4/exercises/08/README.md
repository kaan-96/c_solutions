...
Whenever `total % 10 != 0`, the addition of the `% 10` in the second expression has no effect on the result - the maximum value of `10 - total % 10` is 10 after all (assuming negative digits are not permitted).
